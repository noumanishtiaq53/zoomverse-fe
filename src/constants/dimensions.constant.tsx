...
export const PROFILE_STATUS_BADGE_MARGIN = {
  [PROFILE_AVATAR_DIMENSIONS_TYPES?.EXTRA_SMALL]: 0.2,
  [PROFILE_AVATAR_DIMENSIONS_TYPES?.SMALL]: 0.2,
  [PROFILE_AVATAR_DIMENSIONS_TYPES?.MEDIUM]: 0.7,
  [PROFILE_AVATAR_DIMENSIONS_TYPES?.LARGE]: 1.5,
};
